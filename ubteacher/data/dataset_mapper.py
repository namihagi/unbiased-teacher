...
class DatasetMapperForEvalWithTrainMode(DatasetMapper):
    """
    This is used by evaluation of psedo-label with train mode.
    The difference from DatasetMapper is that even when is_train == False,
    annotations and sem_seg_file_name are not popped.
    """
